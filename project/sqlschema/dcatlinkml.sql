...
-- # Class: "catalog" Description: "Represents a catalog"
...
--     * Slot: name Description: A human-readable name for a thing
--     * Slot: description Description: A human-readable description for a thing
--     * Slot: catalogCollection_id Description: Autocreated FK slot
-- # Class: "catalogCollection" Description: "A holder for catalog objects"
--     * Slot: id Description: 
...
CREATE TABLE catalog (
	...
	name TEXT, 
	description TEXT, 
	"catalogCollection_id" INTEGER, 
	PRIMARY KEY (id), 
	FOREIGN KEY("catalogCollection_id") REFERENCES "catalogCollection" (id)
);